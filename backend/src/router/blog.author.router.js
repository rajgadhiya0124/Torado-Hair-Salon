...
import { creatBlogAuthor, deleteBlogAuthor, getAllBlogAuthor, updateBlogAuthor, updateBlogAuthorStatus } from "../controller/blog.author.controller.js";
...
router.put("/updateStatus/:id",verifyToken,updateBlogAuthorStatus);
